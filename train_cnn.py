...
tf.flags.DEFINE_string("find_data_file", "./Data_Training_CNN/Data.findRestaurantsByCity", "Data source for the findRestaurantsByCity data.")
tf.flags.DEFINE_string("greet_data_file", "./Data_Training_CNN/Data.greet", "Data source for the greet data.")
tf.flags.DEFINE_string("bye_data_file", "./Data_Training_CNN/Data.bye", "Data source for the bye data.")
tf.flags.DEFINE_string("affirmative_data_file", "./Data_Training_CNN/Data.affirmative", "Data source for the affirmative data.")
tf.flags.DEFINE_string("negative_data_file", "./Data_Training_CNN/Data.negative", "Data source for the negative data.")
